...
var e = {
    ...
    darkMode: function () {
        ...
        var changeThemeToDark = () => {
          ...
          if(dir == 'rtl') {
              style.setAttribute('href', 'vendor/css/style-dark-rtl.css');
          } else {
              style.setAttribute('href', 'vendor/css/style-dark.css');
          }
        ...
        var changeThemeToLight = () => {
          ...
          if(dir == 'rtl') {
              style.setAttribute('href', 'vendor/css/style-rtl.css');
          } else {
              style.setAttribute('href', 'vendor/css/style.css');
          }
